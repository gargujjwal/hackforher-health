...
public class UserProfileServiceImpl implements UserProfileService {
  ...
  public PatientProfileDto updatePatientProfile(
      Long patientId, @Valid PatientProfileDto patientProfileUpdateDto) {
  ...
  @Override
  public DoctorProfileDto updateDoctorProfile(
      Long doctorId, @Valid DoctorProfileDto doctorProfileRequestDto) {
  ...
  @Override
  public Page<DoctorProfileDto> getAllDoctors(PageRequest pageRequest) {
    return doctorRepository
        .findAllByOrderByAvgRatingDesc(pageRequest)
        .map(doctor -> doctorProfileMapper.toDto(doctor.getProfile()));
  }
