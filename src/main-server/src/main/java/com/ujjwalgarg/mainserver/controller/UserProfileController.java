...
public class UserProfileController {
  ...
  public ResponseEntity<ApiResponse<?>> getUserProfile(@PathVariable("role") Role role,
  ...
  public ResponseEntity<ApiResponse<PatientProfileDto>> updatePatientProfile(
    ...
    PatientProfileDto responseDto = userProfileService.updatePatientProfile(userId,
  ...
  public ResponseEntity<ApiResponse<DoctorProfileDto>> updateDoctorProfile(
    ...
    DoctorProfileDto responseDto = userProfileService.updateDoctorProfile(userId,
        profileUpdateRequest);
    return ResponseEntity.ok(ApiResponse.success(responseDto));
  }
}
