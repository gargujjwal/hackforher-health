...
module.exports = {
  content: [
    ...
    "./node_modules/@heroui/theme/dist/components/(accordion|avatar|badge|button|card|checkbox|chip|code|date-input|date-picker|dropdown|image|input|kbd|link|modal|navbar|pagination|radio|select|snippet|toggle|table|tabs|popover|divider|ripple|spinner|calendar|menu|listbox|scroll-shadow|spacer).js",
  ],
  theme: {
    extend: {},
  },
