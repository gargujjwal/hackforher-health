...
module.exports = {
  content: [
    ...
    "./node_modules/@nextui-org/theme/dist/components/(avatar|badge|button|card|checkbox|chip|code|date-input|date-picker|dropdown|image|input|kbd|link|modal|navbar|pagination|radio|select|snippet|toggle|table|tabs|popover|ripple|spinner|calendar|menu|divider|listbox|scroll-shadow|spacer).js",
  ],
  theme: {
    extend: {},
  },
