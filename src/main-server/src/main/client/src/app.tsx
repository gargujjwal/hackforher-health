...
import QuestionnaireSubmissionReviewPage
  from "./pages/dashboard/doctor/questionnaire-submission/[questionnaireSubmissionId].review.index";
...
import QuestionnaireSubmissionViewPage
  from "./pages/dashboard/patient/questionnaire-submission/view.index";
