        ...
        {medicalCase.isSuccess && (
            <>
              ...
              {medicalCase.data.isResolved ? (
                  ...
                  <Card
                      className="mx-auto mt-8 bg-primary text-textPrimary md:w-max md:flex-row md:gap-4">
              ...
              <div className="mt-8 flex w-full flex-col">
                ...
                >
                  <Tab
                      ...
                      title={
                        <div
                            className="flex items-center space-x-2 group-data-[selected=false]:text-secondary group-data-[selected=true]:text-textPrimary">
                          <FaClipboardQuestion
                              className="size-5 group-data-[selected=false]:text-secondary group-data-[selected=true]:text-textPrimary"/>
